...
class PIQI_EXPORT Piqi : public QObject {
  ...
  public:
    ...
    QCoro::Task<Recommended *>
    RecommendedFeedTask(QString type, bool includeRanking = false, bool includePrivacyPolicy = false);
    QCoro::Task<RecommendedNovels *> RecommendedNovelsFeedTask(bool includeRanking = false,
  ...
  public Q_SLOTS:
    ...
    QCoro::QmlTask BookmarksFeed(User *user = nullptr,
                                 bool restricted = false,
                                 QString tag = ""); // Add back user with nullptr value by default
    QCoro::QmlTask NovelsBookmarksFeed(User *user = nullptr,
                                       bool restricted = false,
                                       QString tag = ""); // Same as with normal BookmarksFeed
